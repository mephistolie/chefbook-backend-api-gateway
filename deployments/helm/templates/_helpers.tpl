...
*/}}
{{- define "chefbook-backend-api-gateway.name" -}}
...
*/}}
{{- define "chefbook-backend-api-gateway.fullname" -}}
...
*/}}
{{- define "chefbook-backend-api-gateway.chart" -}}
...
Common labels
*/}}
{{- define "chefbook-backend-api-gateway.labels" -}}
helm.sh/chart: {{ include "chefbook-backend-api-gateway.chart" . }}
{{ include "chefbook-backend-api-gateway.selectorLabels" . }}
{{- if .Chart.AppVersion }}
